...
<a href="https://pkg.go.dev/github.com/stainless-sdks/simplechecks-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/simplechecks-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/simplechecks-go" // imported as simplechecks
)
```
...
```sh
go get -u 'github.com/stainless-sdks/simplechecks-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/simplechecks-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/simplechecks-go/issues) with questions, bugs, or suggestions.
