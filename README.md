...
<a href="https://pkg.go.dev/github.com/simplechecks/sdk-go"><img src="https://pkg.go.dev/badge/github.com/simplechecks/sdk-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/simplechecks/sdk-go" // imported as simplechecks
)
```
...
```sh
go get -u 'github.com/simplechecks/sdk-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/simplechecks/sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/simplechecks/sdk-go/issues) with questions, bugs, or suggestions.
